    ...
    <span class="tooltipBoxPosition <?php echo "tooltipBoxPosition".$autoincrement;?>">
        ...
        while($row2 = mysqli_fetch_assoc($cuSerial)){
            ...
            if(strlen($row2["placa_equipo"]) != 0) {
                ...
                <p>Serial:</p>
                <input class="inputsCUSerial" type="text" name="TorreCU" value="<?php echo $row2["serial_equipo"];?>" disabled>
                <br><br>

                <p class="titleType">Monitor</p>
                <p>CU:</p>
                <input class="inputsCUSerial" type="text" name="TorreCU" value="<?php echo $row2["placa_m"];?>" disabled>
                <p>Serial:</p>
                <input class="inputsCUSerial" type="text" name="TorreCU" value="<?php echo $row2["serial_m"];?>" disabled>
